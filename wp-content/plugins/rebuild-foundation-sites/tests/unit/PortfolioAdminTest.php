...
class Rebuild_SitesAdminTest extends WP_UnitTestCase {

	protected $admin;

	public function setUp() {
		parent::setUp();
		$this->admin = new Rebuild_Sites_Post_Type_Admin( null );
	}

	public function testBuildTermOptions() {
		$method = new ReflectionMethod(	'Rebuild_Sites_Post_Type_Admin', 'build_term_options' );
