...
class Rebuild_SitesPostTypeUnitTest extends WP_UnitTestCase {
	...
	public function setUp() {
		parent::setUp();
		$this->object = new Rebuild_Sites_Post_Type_Post_Type;
	...
	private function get_default_args() {
		$method = new ReflectionMethod(	'Rebuild_Sites_Post_Type_Post_Type', 'default_args' );
