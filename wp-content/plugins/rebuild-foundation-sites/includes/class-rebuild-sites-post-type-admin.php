...
class Rebuild_Sites_Post_Type_Admin {
	...
	public function add_thumbnail_column( $columns ) {
		$column_thumbnail = array( 'thumbnail' => __( 'Thumbnail', 'rebuild-foundation-sites' ) );
    ...
    public function add_icons() {
    	...
    	if ( version_compare( $GLOBALS['wp_version'], '3.8', '>=' ) ) {
			...
			?>
		    <style>
				#dashboard_right_now .rebuild-site-count a:before {
					content: "\f322";
				}
		    </style>
		<?php }
