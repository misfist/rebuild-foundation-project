...
function give_pdf_template_blue_stripe( $give_pdf, $give_pdf_payment, $give_pdf_payment_meta, $give_pdf_buyer_info, $give_pdf_payment_gateway, $give_pdf_payment_method, $address_line_2_line_height, $company_name, $give_pdf_payment_date, $give_pdf_payment_status ) {
	...
	$give_pdf->SetFont( 'droidserif', '', 12, '', true );

	$give_pdf->AddPage();

	$give_pdf->SetX( 35 );

	$give_pdf->SetFont( 'droidserif', '', 12 );
	...
	$give_pdf->SetFont( 'droidserif', '', 32 );
	...
	$give_pdf->SetTextColor( 50, 50, 50 );
	$give_pdf->SetFont( 'droidserif', '', 10 );
	$give_pdf->Cell( 0, 6, $give_pdf_payment_date, 0, 2, 'R', false );

	$give_pdf->SetX( 35 );

	$give_pdf->SetFont( 'droidserifb', '', 10 );
	...
	$line_height_totals = give_pdf_calculate_line_height( $give_options['give_pdf_name'] ) + give_pdf_calculate_line_height( $give_options['give_pdf_address_line1'] ) + give_pdf_calculate_line_height( $give_options['give_pdf_address_line2'] ) + give_pdf_calculate_line_height( $give_options['give_pdf_address_city_state_zip'] ) + give_pdf_calculate_line_height( $give_options['give_pdf_email_address'] );
	...
	if ( $give_pdf_payment_meta ) {
		...
		if ( isset ( $give_options['give_pdf_additional_notes'] ) && ! empty( $give_options['give_pdf_additional_notes'] ) ) {
			$give_pdf->SetX( 35 );
			$give_pdf->SetFont( 'droidserif', '', 13 );
			$give_pdf->SetTextColor( 149, 210, 236 );
