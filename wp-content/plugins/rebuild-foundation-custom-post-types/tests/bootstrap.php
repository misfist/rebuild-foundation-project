...
require plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rebuild-sites-post-type.php';
require plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rebuild-sites-post-type-registrations.php';
...
require plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rebuild-sites-post-type-admin.php';
...
require plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rebuild-sites-post-type-post-type.php';
require plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rebuild-sites-post-type-taxonomy-category.php';
require plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rebuild-sites-post-type-taxonomy-tag.php';
