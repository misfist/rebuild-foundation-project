...
class Rebuild_SitesTaxonomyCategoryUnitTest extends WP_UnitTestCase {
	...
	public function setUp() {
		parent::setUp();
		$this->object = new Rebuild_Sites_Post_Type_Taxonomy_Category;
	...
	private function get_default_args() {
		$method = new ReflectionMethod(	'Rebuild_Sites_Post_Type_Taxonomy_Category', 'default_args' );
