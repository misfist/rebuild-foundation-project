...
class Rebuild_SitesTaxonomyTagUnitTest extends WP_UnitTestCase {
	...
	public function setUp() {
		parent::setUp();
		$this->object = new Rebuild_Sites_Post_Type_Taxonomy_Tag;
	...
	private function get_default_args() {
		$method = new ReflectionMethod(	'Rebuild_Sites_Post_Type_Taxonomy_Tag', 'default_args' );
