...
class Gamajo_Single_Entry_Term_Body_Classes {
	...
	public function body_class( $classes ) {
		...
		global $rebuild_sites_post_type_registrations;
		return array_merge( $classes, $this->get_taxonomy_term_classes( $rebuild_sites_post_type_registrations->taxonomies ) );
	}
