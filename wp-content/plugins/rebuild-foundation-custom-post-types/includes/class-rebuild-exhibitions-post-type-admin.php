...
class Rebuild_Exhibitions_Post_Type_Admin {
	...
	public function add_thumbnail_column( $columns ) {
		$column_thumbnail = array( 'thumbnail' => __( 'Thumbnail', 'rebuild-foundation-cpt' ) );
    ...
    public function add_icons() {
    	...
    	if ( version_compare( $GLOBALS['wp_version'], '3.8', '>=' ) ) {
			...
			?>
		    <style>
				#dashboard_right_now .rebuild-exhibitions-count a:before {
					content: "\f322";
				}
		    </style>
		<?php }
